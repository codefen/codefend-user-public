...
export const defaultMobileCloudResourceAsset = ['main cloud', 'mobile1', 'mobile2', 'mobile3', 'mogile4', 'mobile5', "nuevo", 'nuevos cambios', 'Albilad App', 'secondary cloud', 'Red Bus Córdoba']
